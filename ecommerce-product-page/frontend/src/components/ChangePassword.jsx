    ...
    <div className='container form-wrapper'>
      ...
      <form onSubmit={submitHandler} className='login-register-form'>
        ...
        <div className="form-group">
          ...
          <input type={showNewPasswordConfirm ? "text" : "password"}  name="newPasswordConfirm" id="passwordConfirm" value={newPasswordConfirm} onChange={onChangeHandler} required />
          {showNewPasswordConfirm ? <div onClick={() => setShowNewPasswordConfirm(false)}><EyeOpenIcon  /></div> : <div onClick={()=>setShowNewPassword(true)} ><EyeClosedIcon/></div> }
        </div>
