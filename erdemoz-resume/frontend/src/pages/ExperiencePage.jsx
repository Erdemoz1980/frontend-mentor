  ...
  const projects = [
    {
      ...
      description: 'Developed a dynamic full-stack E-commerce platform, showcasing my proficiency in CSS, Javascript, React, Redux, Node, ExpressJS, and MongoDB. Prioritized user experience with features such as secure user registration, login, and profile editing. Implemented efficient search and filtering functionalities, enhancing product discoverability. I also implemented responsive design principles, ensuring a flawless shopping experience across devices creating a seamless shopping experience.',
      technologies: [{ id: 1001, name: 'Javascript' }, { id: 1002, name: 'ExpressJS' }, { id: 1003, name: 'React' }, { id: 1004, name: 'Node' }, { id: 1005, name: 'Redux' }, { id: 1006, name: 'MongoDB' }, { id: 1007, name: 'CSS' }, { id: 1008, name: 'Mongoose' }, { id: 1009, name: 'JSX' }, { id: 1010, name: 'Jason Web Token' }],
      links: {liveDemo:"https://ecommerce.erdemoz.io/", github:"https://github.com/Erdemoz1980/frontend-mentor/tree/main/ecommerce-product-page"}
    },
    {
      id: 10002,
      ...
      links:{liveDemo:"https://galleria.erdemoz.io/", github:"https://github.com/Erdemoz1980/frontend-mentor/tree/main/galleria-slideshow-site"}
    },
    {
      id: 10003,
      ...
      technologies: [{ id: 1001, name: 'Javascript' }, { id: 1002, name: 'JSX' }, { id: 1003, name: 'React' }, { id: 1004, name: 'CSS' }],
      links:{liveDemo:"https://generator.erdemoz.io/", github:"https://github.com/Erdemoz1980/frontend-mentor/tree/main/pro/password-generator-app"}
    },
    {
      id: 10004,
      ...
      technologies: [{ id: 1001, name: 'Javascript' }, { id: 1002, name: 'JSX' }, { id: 1003, name: 'React' }, { id: 1004, name: 'CSS' }],
      links:{liveDemo:"https://tipcalculator.erdemoz.io/", github:"https://github.com/Erdemoz1980/frontend-mentor/tree/main/tip-calculator-app-react"}
    }, {
      id: 10005,
      ...
      technologies: [{ id: 1001, name: 'Javascript' }, { id: 1002, name: 'JSX' }, { id: 1003, name: 'React' }, { id: 1004, name: 'CSS' }],
      links:{liveDemo:"", github:"https://github.com/Erdemoz1980/frontend-mentor/tree/main/static-job-listings"}
